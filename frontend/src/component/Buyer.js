...
const FarmerDashboard = () => {
    ...
    const renderComponent = () => {
        switch (activeComponent) {
            case 'cropPosts':
                return <div className="bg-[#CBE2B5] rounded-lg p-4"><CropPostsComponent /></div>;
            case 'bids':
                return <div className="bg-[#CBE2B5] rounded-lg p-4"><BidsComponent /></div>;
            case 'requirements':
                return <div className="bg-[#CBE2B5] rounded-lg p-4"><RequirementsComponent /></div>;
            case 'addRequirement':
                return <div className="bg-[#CBE2B5] rounded-lg p-4"><AddRequirementsComponent /></div>;
            case 'profile':
                return <div className="bg-[#CBE2B5] rounded-lg p-4"><ProfileComponent /></div>;
            default:
                return <div className="bg-[#CBE2B5] rounded-lg p-4"><CropPostsComponent /></div>;
        }
    };
    ...
    return (
        <div className="bg-[#86AB89] min-h-screen flex flex-col">
